...
<?php	
	...
	*/
	...
	echo "<tr><td colspan='2' align='right'><a href='neww.php' rel='shadowbox' style='font-size:15;color:#BE00BC;'>...more</a></td></tr>";
	echo "</table>";
	...
	echo "</tr>";
	echo "<tr align='center' style='font-size:10; color:#BE00BC; background-color:#FFCDFE'><th>作品連結</th><th>作者</th></tr>";
	$sql_pop = "SELECT stu.s_id, stu.s_name, rework.m_id, rework.pop_point FROM rework,stu,mission WHERE mission.syear=".$syear." AND rework.m_id=mission.m_id AND rework.s_id=stu.s_id AND rework.pop_point>0 ORDER BY pop_point DESC limit 20";
	$result_pop = mysql_query($sql_pop,$pa);
