...
if(isset($_POST["w_name"])) {
	if($_FILES["up_work"]!="")	{
		...
		//新增works紀錄
		$sql = "INSERT INTO works(w_name, w_desc, s_id, m_id, w_date, w_status)";
		$sql .= " VALUES('".$_POST["w_name"]."', './works/".$row_cid["c_id"]."_".$row_cid["c_class"]."/".$desc_file_name."', '".$_COOKIE["s_id"]."', '".$m_id."','".$now_date." ".$now_time2."','1')";
		...
		echo "parent.location.href='show.php?mid=".$m_id."';";
		echo "</script>";
			
		//更新學生進度表，p_uploaded=1，已繳交
		$sql = "UPDATE progress2stu SET p_uploaded='1' WHERE s_id='".$_COOKIE["s_id"]."' AND m_id='".$m_id."'";
		$result = mysql_query($sql,$pa);
...
<table class="outtable">
    ...
    <td colspan="2" align="center" valign="middle">
      <form action="upload.php?mid=<?php echo $m_id;?>" method="post" enctype="multipart/form-data">
        <table width="0">
			<tr>
