...
<?php	
	...
	//$sql_pop = "SELECT stu.s_id, stu.s_name, rework.m_id, rework.pop_point FROM rework,stu WHERE rework.s_id=stu.s_id AND rework.pop_point>0 ORDER BY pop_point DESC";
	$sql_pop = "SELECT stu.s_id, stu.s_name, rework.m_id, rework.pop_point FROM rework,stu,mission WHERE mission.syear=".$syear." AND rework.m_id=mission.m_id AND rework.s_id=stu.s_id AND rework.pop_point>0 ORDER BY pop_point DESC";
