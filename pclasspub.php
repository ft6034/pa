...
<tr>
	...
	<tr>
		<td colspan="2" class="header">[作品繳交狀況一覽表]</td>
	</tr>
	<tr>
		<td class="title">
...
<tr>
    ...
    <iframe frameborder="0" src="pclasspubin.php" name="inpage" width="900 px" height="520 px" scrolling="yes"></iframe>

	
	<!--<div id="scrollee">
	<object id="object" width="800 px" height="500 px" type="text/html" data=" pclasspubin.php "></object>
	</div>-->
	<!--<div id='myMask'><iframe class='myFrame' src='pclasspubin.php'></iframe></div>-->
        <hr>
			...
			<input
				...
				onClick="self.location='pclasspub.php'">
			<input
				type="button"
				name="groovybtn2"
				class="groovybutton-back"
