...
<?php	
	...
	//$sql_pop = "SELECT stu.s_id, stu.s_name, works.m_id, works.pop_point FROM works,stu WHERE works.s_id=stu.s_id AND works.pop_point>0 ORDER BY pop_point DESC";
	$sql_pop = "SELECT stu.s_id, stu.s_name, works.m_id, works.pop_point FROM works,stu,mission WHERE mission.syear=".$syear." AND works.m_id=mission.m_id AND works.s_id=stu.s_id AND works.pop_point>0 ORDER BY pop_point DESC;";
